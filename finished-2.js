...
(function() {
    ...
    function plotData(map) {
        ...
        d3.select('#title').remove()
            ...
            .text("Countries by Life Expectancy and Fertility Rate (" + selected + ")")
        });
            ...
            .style("fill-opacity", "0")
                ...
                .on("mouseover", function(d){
                    div.transition()
                        .duration(200)
                        .style("opacity", .9);
                    div.html("Country: " + d.location + "<br/>" + "Year: " + d.time + "<br/>" + "Life Expectancy: " + d.life_expectancy + "<br/>" + "Fertility Rate: " + d.fertility_rate + "<br/>" + "Population: " + numberWithCommas(d["pop_mlns"]*1000000))
